...
export const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        primary:
          'bg-primary-300 hover:bg-primary-400 focus-visible:ring-primary-400 dark:bg-primary-800 dark:hover:bg-primary-900 text-neutral-900 dark:text-neutral-50',
        secondary:
        ...
        'danger-solid':
          'bg-red-300 hover:bg-red-400 focus-visible:ring-red-400 dark:bg-red-800 dark:hover:bg-red-900 text-neutral-900 dark:text-neutral-50',
        unstyled: '',
      },
      size: {
        xs: 'text-xs h-6 px-3',
